...
img = cv2.imread(r"C:/fake currency/Fake-currency-detection-Python/Dataset/2000/2000front.jpeg")  # reading the image file
img1 = cv2.imread(r"C:/fake currency/Fake-currency-detection-Python/Dataset/2000/2000back.jpeg")
